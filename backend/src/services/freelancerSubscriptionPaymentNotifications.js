  ...
  return notificationService.createIfNotExists(
    {
      ...
      message: "تم تفعيل اشتراكك كمستقل بنجاح.",
      ...
      metadata: {
        ...
        redirectTo: "/dashboard/freelancer/plans",
  ...
  return notificationService.createIfNotExists(
    {
      ...
      type: "payment_failed",
      title: "فشل الدفع",
      message: "تعذّر إتمام عملية الدفع. يرجى المحاولة مرة أخرى.",
      entityType: "subscription",
      entityId: subId,
      link: "/dashboard/freelancer/plans",
      priority: "high",
