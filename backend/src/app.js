...
const publicPlansContentRoutes = require("./routes/publicPlansContentRoutes");
const publicSpecialOfferPackageRoutes = require("./routes/publicSpecialOfferPackageRoutes");
const superAdminPublicPlansContentRoutes = require("./routes/superAdminPublicPlansContentRoutes");
const superAdminSpecialOfferPackageRoutes = require("./routes/superAdminSpecialOfferPackageRoutes");
const superAdminTrainingPackagesRoutes = require("./routes/superAdminTrainingPackagesRoutes");
...
app.use("/api", publicPlansContentRoutes);
app.use("/api", publicSpecialOfferPackageRoutes);
...
app.use("/api/super-admin", superAdminPublicPlansContentRoutes);
app.use("/api/super-admin", superAdminSpecialOfferPackageRoutes);
app.use("/api/super-admin", superAdminTrainingPackagesRoutes);
