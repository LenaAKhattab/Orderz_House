...
void main() {
  group('AppBranding', () {
    test('display name is Arabic user-facing brand', () {
      expect(AppBranding.displayNameAr, 'أوردرز هاوس');
    });
