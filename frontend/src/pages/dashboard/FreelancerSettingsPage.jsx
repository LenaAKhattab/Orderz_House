...
export default function FreelancerSettingsPage() {
  ...
  return (
    <div className="oh-account-page" dir="rtl">
      <div className="oh-account-hero">
        <p className="oh-account-hero__kicker">إعدادات المستقل</p>
        <h1 className="oh-account-hero__title">إعدادات الحساب</h1>
        <p className="oh-account-hero__lead">حدّث معلوماتك العامة، أمان الحساب، والإشعارات. جميع الحقول تُحفظ عبر واجهة برمجة التطبيقات.</p>
      </div>
