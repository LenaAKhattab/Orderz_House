              ...
              {rows.length === 0 ? (
                <tr>
                  <td colSpan={8} style={{ textAlign: "center", padding: 24 }}>
                    لا توجد طلبات تجريبية بمتقدمين ضمن المرشحات.
                  </td>
                </tr>
              ) : (
                rows.map((r) => (
                  <tr key={r.fakeOrderId}>
                    ...
                    <td>
                      <div style={{ display: "flex", flexWrap: "wrap", gap: 6, justifyContent: "flex-end" }}>
                        <span className="oh-training-badge">
                          جولة: {ROUND_STATUS_AR[r.roundStatus] || r.roundStatus || "—"}
                        </span>
                        <span className="oh-training-badge oh-training-badge--muted">
        ...
        >
          <div className="oh-training-modal oh-training-modal--applicants oh-training-modal__card" role="dialog" aria-modal="true" aria-labelledby="training-apps-modal-title">
            ...
            {modalLoading ? (
              ...
              <p className="help">لا يوجد متقدمون لهذا الطلب.</p>
            ) : (
