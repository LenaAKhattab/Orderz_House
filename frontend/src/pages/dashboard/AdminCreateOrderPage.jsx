...
import { SelectPanelBusySkeleton } from "../../components/ui/Skeleton";
...
export default function AdminCreateOrderPage() {
  ...
  const [subSubcategoryQuery, setSubSubcategoryQuery] = useState("");
  ...
  useEffect(() => {
    // Reset search box when project type changes
    setCurrencyQuery("");
  }, [form.projectType]);
  ...
  useEffect(() => {
    // Reset search queries when parent changes (keeps UX clean)
    setSubSubcategoryQuery("");
  }, [form.categoryId]);
  ...
  const submitOrder = async () => {
    ...
    try {
      ...
      if (form.projectType === "fixed") {
        ...
        fd.append("budget", String(Number(form.budget)));
      }
  ...
  const currencyOptions = useMemo(() => {
    return [
      { value: "JOD", label: "دينار أردني", meta: "JOD" },
      { value: "SAR", label: "ريال سعودي", meta: "SAR" },
      { value: "AED", label: "درهم إماراتي", meta: "AED" },
      { value: "USD", label: "دولار أمريكي", meta: "USD" },
      { value: "EUR", label: "يورو", meta: "EUR" },
      { value: "KWD", label: "دينار كويتي", meta: "KWD" },
      { value: "QAR", label: "ريال قطري", meta: "QAR" },
      { value: "BHD", label: "دينار بحريني", meta: "BHD" },
      { value: "OMR", label: "ريال عماني", meta: "OMR" },
    ];
  }, []);
    ...
    <main className="container page-content">
      ...
      >
        ...
        <section className="card" style={{ gridColumn: "span 12" }}>
          {currentStepKey === "core" ? (
            <>
              <h2 style={{ marginBottom: 10 }}>1) بيانات الطلب</h2>

              <div className="oh-wizard-section">
                <div className="oh-wizard-section__title">المعلومات الأساسية</div>
              ...
              <div className="oh-wizard-section">
                <div className="oh-wizard-section__title">التصنيف</div>
                <div className="form-grid">
                  <div className="oh-row-2col">
                    <div className="field">
                      ...
                      <SearchableSelect
                        ...
                        onChange={(v) => {
                          set("categoryId", v);
                          // Clear dependent selection/options immediately (prevents stale list issues)
                          setSubSubcategories([]);
                          setSubSubBusy(false);
                          setSubSubcategoryQuery("");
                    ...
                    <div className="field">
                      ...
                      <SearchableSelect
                        ...
                        onChange={(v) => set("subSubcategoryId", v)}
                        placeholder={form.categoryId ? "اختر التصنيف التفصيلي (اختياري)" : "اختر التصنيف أولاً"}
                        options={subSubcategoryOptions}
                        busy={subSubBusy}
                        query={subSubcategoryQuery}
                        onQueryChange={setSubSubcategoryQuery}
                  ...
                  <div style={{ gridColumn: "span 12" }}>
                    <label style={{ display: "block", fontWeight: 800, marginBottom: 6 }}>تصنيفات إضافية (اختياري)</label>

                    <div style={{ display: "grid", gap: 12 }}>
                      {(form.extraCategoryIds || []).map((id) => {
                        const label = categoryOptions.find((o) => String(o.value) === String(id))?.label || id;
                        ...
                        return (
                          <div key={String(id)} className="oh-row-2col">
                            <div className="field">
                              <label>التصنيف</label>
                              <div className="input" style={{ display: "flex", alignItems: "center", minHeight: 44, fontWeight: 900 }}>
                                {label}
                              </div>
                            </div>
                            <div className="field">
                              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10 }}>
                                <label style={{ margin: 0 }}>التصنيف التفصيلي</label>
                                <button
                                  type="button"
                    ...
                    <div style={{ marginTop: 10, display: "grid", gap: 8, justifyItems: "stretch" }}>
                      <button
                        type="button"
                        className="btn btn-secondary"
                        style={{ padding: "5px 12px", fontSize: "0.85rem", fontWeight: 800, width: "fit-content" }}
                  ...
                  <div style={{ gridColumn: "span 12" }}>
                    <label style={{ display: "block", fontWeight: 800, marginBottom: 6 }}>المهارات المطلوبة</label>
                    <SkillsTagsInput
              ...
              <div className="oh-wizard-section">
                <div className="oh-wizard-section__title">التسعير والنوع</div>
                <div className="form-grid">
                  <div className="field" style={{ gridColumn: "span 4" }}>
                    ...
                    >
                      ...
                      <option value="bidding">مزايدة</option>
                    </select>
                  ...
                  {form.projectType === "fixed" ? (
                    ...
                    <div className="field" style={{ gridColumn: "span 4" }}>
                      <label>العملة</label>
                      <div className="help">لا توجد عملة مطلوبة عند اختيار “مزايدة”.</div>
                      <FieldError message="" />
                    </div>
                  )}
                  {form.projectType === "fixed" ? (
                    ...
                    <div className="field" style={{ gridColumn: "span 4" }}>
                      <label>الميزانية</label>
                      <div className="help">لا توجد ميزانية مطلوبة عند اختيار “مزايدة”.</div>
                      <FieldError message="" />
                    </div>
                  )}
                </div>
              ...
              <div className="oh-wizard-section">
                <div className="oh-wizard-section__title">مدة التسليم</div>
                <div className="form-grid">
                  ...
                  <div className="field" style={{ gridColumn: "span 6" }}>
                    ...
                    >
                      <option value="">{`اختر وحدة الزمن`}</option>
