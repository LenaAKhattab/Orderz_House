    ...
    <footer
      className={
        homeBlend
          ...
          : "site-footer site-footer--public mt-auto border-t border-[rgba(47,59,101,0.12)] bg-[#f8f9fb] pb-[env(safe-area-inset-bottom,0)]"
      }
    >
      <div className="mx-auto grid w-full max-w-[min(1160px,calc(100%-48px))] grid-cols-1 items-start gap-x-5 gap-y-6 px-0 py-[34px] pb-[42px] sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-[1fr_0.8fr_0.85fr_1fr_0.9fr_1.4fr]">
        <section className="min-w-0">
          <h3 className="mb-3 text-[0.98rem] font-bold text-[#2f3b65]">استكشف</h3>
        ...
        <section className="min-w-0 border-s border-dashed border-[rgba(47,59,101,0.16)] ps-[18px] max-lg:border-0 max-lg:ps-0">
          ...
          <div className="mt-[18px] border-t border-dashed border-[rgba(47,59,101,0.16)] pt-3.5">
      ...
      <div
        className={
          homeBlend
            ? "site-footer__bottom-bar border-t border-[rgba(47,59,101,0.08)] bg-transparent py-[18px] pb-7"
            : "site-footer__bottom-bar border-t border-[rgba(47,59,101,0.12)] bg-white py-[18px] pb-7"
        }
      >
        ...
        <p className="site-footer__copyright">
          © 2024 أوردر هاوس. جميع الحقوق محفوظة.
          <span className="site-footer__copyright-heart" aria-hidden>
            ♥
          </span>
        </p>
      </div>
