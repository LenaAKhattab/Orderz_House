...
function IntroText() {
  return (
    <>
      يرجى تعبئة البيانات المطلوبة <Emph>بدقة كاملة</Emph> وبما يتوافق مع المعلومات التي تم
      تقديمها سابقًا في <Emph>طلب/عقد الانضمام الأول</Emph>.
    </>
  );
}
    ...
    <>
      ...
      >
        ...
        <p className="oh-legacy-instructions__declaration-text">
          من خلال تعبئة هذا النموذج، فإنك تؤكد أن البيانات المدخلة صحيحة وكاملة، وتتحمل مسؤولية
          صحتها.
        </p>
      </section>
    </>
