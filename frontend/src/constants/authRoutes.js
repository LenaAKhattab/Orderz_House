...
export const DASHBOARD_TITLE = {
  ...
  "/dashboard/freelancer/my-articles": "مقالاتي",
...
export const DASHBOARD_TITLE_KEYS = {
  ...
  "/dashboard/freelancer/my-articles": "dashboard.nav.freelancer.myArticles",
...
const DASHBOARD_PATH_TO_ROLES = {
  ...
  "/dashboard/freelancer/my-articles": [ROLE.FREELANCER],
...
const DASHBOARD_PREFIX_RULES = [
  ...
  { prefix: "/dashboard/freelancer/my-articles", roles: [ROLE.FREELANCER] },
